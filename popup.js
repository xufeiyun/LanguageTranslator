...
$(document).ready(function () {
    ...
    $("#" + PronounceAudios.Source.ButtonId).click(function () {
        pronounceText(PronounceAudios.Source.PlayerId);
    });
    $("#" + PronounceAudios.Main.ButtonId).click(function () {
        pronounceText(PronounceAudios.Main.PlayerId);
    });
    $("#" + PronounceAudios.More.ButtonId).click(function () {
        pronounceText(PronounceAudios.More.PlayerId);
    });
...
function pronounceText(playerId)
{
    var player = $("#" + playerId);
    if (isDefined(player)) {
...
function translateByMessage(activeTab)
{
	...
	pup2tab(OperatorType.selectText, "selectText");
}
...
function resp_pup(response)
{
	...
	if (type == OperatorType.selectText)
	{
